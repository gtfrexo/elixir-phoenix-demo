{application,db,
             [{applications,[kernel,stdlib,elixir,logger,runtime_tools,faker,
                             gettext,poison,phoenix_pubsub,cowboy,cors_plug,
                             phoenix,postgrex,dataloader,absinthe,
                             absinthe_plug,absinthe_ecto,phoenix_ecto]},
              {description,"db"},
              {modules,['Elixir.Db','Elixir.Db.Application',
                        ...
                        'Elixir.Db.Repo','Elixir.Db.Test_Resolver',
                        'Elixir.Db.Tests','Elixir.Db.Tests.Test',
                        ...
                        'Elixir.DbWeb.TestController','Elixir.DbWeb.TestView',
